{
  programs.nvf.settings.vim.mini = {
    ...
    # extra.enable = true; # Extra 'mini.nvim' functionality
    # files.enable = true; # Navigate and manipulate file system
    # git.enable = true; # Git integration
    # jump.enable = true; # Jump to next/previous single character
    # jump2d.enable = true; # Jump within visible lines
    # misc.enable = true; # Miscellaneous functions
    # pick.enable = true; # Pick anything
    # sessions.enable = true; # Session management
    # visits.enable = true; # Track and reuse file system visits

    # Appearance
    # animate.enable = true; # Animate common Neovim actions
    # base16.enable = true; # Base16 colorscheme creation
    # colors.enable = true; # Tweak and save any color scheme
